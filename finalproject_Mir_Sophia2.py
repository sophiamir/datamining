...
print(cdat['MONTH'].value_counts())
print(cdat.describe(include='all'))

#cdat20 = cdat.YEAR == '2020'
#cdat21 = cdat[cdat['YEAR' == '2021']]
#cdat22 = cdat[cdat['YEAR' == '2022']]
#print(cdat20.describe(include='all'))
#print(cdat21.describe(include='all'))
#print(cdat22.describe(include='all'))
...
hm = sns.heatmap(cdat_cm, cbar=False, annot=True, square=True, fmt='d', annot_kws={'size': 20}, yticklabels=cdat_cm.columns, xticklabels=cdat_cm.columns)
hm.yaxis.set_ticklabels(hm.yaxis.get_ticklabels(), rotation=0, ha='right', fontsize=20)
hm.xaxis.set_ticklabels(hm.xaxis.get_ticklabels(), rotation=90, ha='right', fontsize=20)
plt.ylabel('True label', fontsize=20)
plt.xlabel('Predicted label', fontsize=20)
# Show heat map
plt.tight_layout()
